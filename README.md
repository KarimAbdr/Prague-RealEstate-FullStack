...
* **Estimated Rent** Provides a predicted monthly rental income based on current market data and the unit's specific characteristics (floor, condition, amenities).
...
* **Custom Inputs**
    Users can toggle features like garage, balcony, or proximity to transit to see how they impact market value.

* **High Accuracy**
    The underlying Machine Learning model is trained on real-market data, achieving an $R^2$ score of 0.85, ensuring reliable and data-driven estimates.
...
* **📈 Market Trends**
  Visualize rent and sale price distributions across different Prague districts to spot market shifts.

* **🏘️ Inventory Analysis**
  Track the volume of listings categorized by disposition (e.g., `1+kk`, `3+1`) and specific geographic locations.

* **⚖️ Comparative Stats**
  Compare average rental yields and prices to identify undervalued areas or high-demand layouts.
...
The platform features an intelligent chatbot that acts as a personal real estate consultant. 

> **Beyond the Search Bar:** Unlike a simple filter, the assistant understands context and provides data-backed advice in natural language.

#### Core Capabilities

* **🗣️ Natural Language Queries** Ask complex questions like *"Find me a 2+kk near Stromovka park under 25,000 CZK"* or *"Which district has the fastest growing rents?"*

* **🧠 RAG-Powered Accuracy** The bot uses **Retrieval-Augmented Generation** to query the live database of listings and market statistics. This ensures every answer is grounded in real-time data, preventing AI "hallucinations."

* **💡 Smart Recommendations** Compare districts side-by-side (e.g., **Žižkov vs. Holešovice**) and get suggestions on where to invest based on the latest scraped market trends.
